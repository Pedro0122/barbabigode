...
<html>
    ...
    <body>
        ...
        <form name="formServico" action="" method="post">
            <div id="body">
                <h1><span>Atendimentos Cadastrados</span></h1>
                <table>
                    <tr>
                        <th>NOME</th>
                        <th>SERVIÇO</th>
                    ...
                    <?php 
                        ...
                        $query = "SELECT servico.descricao, filial.descricaoFilial, atendimento.* FROM servico JOIN atendimento ON servico.idServico = atendimento.idServico JOIN filial ON filial.idFilial = atendimento.idFilial;
                        ";
