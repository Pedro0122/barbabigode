<?php
    if(isset($_POST['submit'])){
        ...
        $result = mysqli_query($conn, "INSERT INTO atendimento(nome, idServico, idFilial, dataAtendimento, horario) VALUES('$nome', '$servico', '$filial', '$data', '$horario')");

        if ($result) {
            echo "<script>alert('Atendimento agendado com sucesso!')</script>";
        } else {
...
<html>
    ...
    <body>
        ...
        <form name="formServico" action="atendimento.php" method="post">
            <div id="body">
                    ...
                    <li>
                        ...
                        <select name="txtFilial" id="" class="input">
                            <?php 
                                ...
                                $filial = "SELECT idFilial, descricaoFilial FROM filial";
